...
export const banks: Bank[] = [
  ...
  { name: 'Punjab National Bank', slug: 'pnb', rate: 8.6, maxRate: 9.4 },
  { name: 'Bank of Baroda', slug: 'bob', rate: 8.6, maxRate: 9.5 },
  ...
  { name: 'IDFC First Bank', slug: 'idfc', rate: 8.95, maxRate: 10.75 },
  { name: 'Yes Bank', slug: 'yes', rate: 9.05, maxRate: 10.25 },
  { name: 'Bajaj Finserv', slug: 'bajaj', rate: 9.1, maxRate: 11.5 },
