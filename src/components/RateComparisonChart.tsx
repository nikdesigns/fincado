      ...
      <CardHeader className="border-b border-slate-100 bg-slate-50 pb-4">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <CardTitle className="flex items-center gap-2 text-lg font-semibold text-slate-800">
            <BarChart3 className="h-5 w-5 text-[#577A30]" />
            Interest Rate Comparison
          </CardTitle>

          <div className="inline-flex items-center gap-1 rounded-full border border-[#DFF7C6] bg-[#F7FDF1] px-3 py-1 text-xs font-semibold text-[#577A30]">
