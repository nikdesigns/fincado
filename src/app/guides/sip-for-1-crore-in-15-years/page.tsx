...
export const metadata: Metadata = {
  ...
  description:
    'Want to build ₹1 Crore wealth in 15 years? See the exact monthly SIP required (₹19,819), step-up strategy, and asset allocation to hit your goal by 2040.',
  keywords: [
...
export default function Sip1Cr15YearsPage() {
  const pageTitle = 'How much SIP is needed for ₹1 Crore in 15 Years?';

  const faqData = [
    {
      question: 'Is ₹1 crore realistic in 15 years via SIP?',
      answer:
        'Yes, 15 years is the "sweet spot" for compounding. It requires a manageable SIP of ~₹19,819/month at 12% returns, making it highly achievable for mid-career professionals.',
    },
    {
      question: 'What return rate is safe to assume for 15 years?',
      answer:
        'A 12% CAGR is a standard, conservative estimate for diversified Equity Mutual Funds over 15+ years. While markets can give 14-15%, planning with 12% provides a safety margin.',
    },
    {
      question: 'Is SIP safer than Lump Sum for 15 years?',
      answer:
        'Yes. Over 15 years, you will likely face 2-3 major market corrections. SIPs turn these crashes into opportunities by buying more units at lower prices (Rupee Cost Averaging).',
    },
    {
      question: 'Should I decrease equity allocation near the 15th year?',
      answer:
        'Absolutely. As you approach your goal (Year 13-15), you should systematically transfer (STP) accumulated wealth into safer Debt funds to protect it from a sudden market crash just before maturity.',
    },
    {
      question: 'Can I start with less than ₹19k?',
      answer:
        'Yes! Using a Step-Up SIP of 10% annually, you can start with approx ₹11,000/month and still reach ₹1 Crore in 15 years as your income and investments grow.',
    },
  ];
    ...
    <article className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            headline: pageTitle,
            description:
              'Detailed calculation and strategy to build a corpus of ₹1 Crore in 15 years using Mutual Funds.',
            author: {
              '@type': 'Person',
      ...
      <Card className="mb-10 border-slate-200 bg-white shadow-sm">
        <CardContent className="pt-6 text-slate-700 leading-relaxed text-lg">
          ...
          <WikiText
            content={`<p>Building a corpus of ₹1 Crore is a definitive financial milestone. Achieving this in <strong>15 years</strong> is considered the "Sweet Spot" of wealth creation—it balances a manageable monthly investment with the massive power of compounding. Unlike shorter tenures, here your investment returns contribute nearly 65% of your final wealth.</p>`}
          />
      ...
      <Card className="mb-12 bg-emerald-50 border-emerald-200 shadow-md">
        ...
        <CardContent>
          <p className="text-emerald-800 text-lg mb-6">
            To reach <strong>₹1 Crore in 15 Years</strong>, assuming a 12%
            annual return from equity mutual funds, you need to start a monthly
            SIP of roughly <span className="font-bold text-2xl">₹19,819</span>.
          </p>
      ...
      <section className="mb-12">
        ...
        >
          <Calculator className="h-6 w-6 text-blue-600" /> The Math: How ₹20k
          Becomes ₹1 Crore
        </h2>
        <p className="mb-6 text-slate-700">
          In a 15-year journey, the magic of compounding does the heavy lifting.
          You invest less than 36% of the final amount, and the market earns the
          rest for you.
        </p>
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>₹35.67 Lakhs</TableCell>
              </TableRow>
              <TableRow>
      ...
      <section className="mb-12">
        <h2
          ...
          className="mb-6 text-2xl font-bold text-slate-900 scroll-mt-20 flex items-center gap-2"
        >
          <Clock className="h-6 w-6 text-amber-500" /> The Magic of 5 Extra
          Years
        </h2>
        <div className="bg-amber-50 border border-amber-100 rounded-lg p-4 mb-6">
          <p className="text-sm text-amber-900">
            <strong>Key Insight:</strong> By extending your timeline from 10 to
            15 years, your required monthly SIP drops by{' '}
            <strong>over 50%</strong> (from ₹43k to ₹19k). This proves that time
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow className="bg-emerald-50/50">
                ...
                <TableCell className="text-emerald-900">₹35.6 L</TableCell>
      ...
      <section className="mb-12">
        ...
        <p className="mb-6 text-slate-700">
          Can&apos;t start with ₹20k? Start small and increase your SIP by 10%
        ...
        <Card className="border-purple-100 bg-purple-50/30 mb-6">
          <CardHeader className="pb-2 border-b border-purple-100">
            <CardTitle className="text-purple-900 text-lg flex items-center gap-2">
              <Zap className="h-5 w-5" /> The Plan (Start Small)
            </CardTitle>
          </CardHeader>
          <CardContent className="pt-4 text-sm text-slate-700">
            <ul className="space-y-3">
              <li className="flex justify-between items-center">
                ...
                <strong className="text-base">₹11,000 / month</strong>
              </li>
              <li className="flex justify-between items-center">
          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>₹1.4 L</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Year 5</TableCell>
                <TableCell>₹16,100</TableCell>
                <TableCell>₹11.2 L</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Year 10</TableCell>
                <TableCell>₹25,900</TableCell>
                <TableCell>₹38.5 L</TableCell>
              </TableRow>
      ...
      <section className="mb-12">
        ...
        <p className="mb-6 text-slate-700">
          For a 15-year horizon, you can afford moderate risk for high growth.
          Equity Mutual Funds are the ideal vehicle.
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="border-l-4 border-l-emerald-500 shadow-sm h-full">
            ...
            <CardContent className="text-sm text-slate-700">
              ...
              <p className="text-xs italic text-slate-500">
                Risk: Moderate. Stable growth aligned with market.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-l-4 border-l-red-500 shadow-sm h-full">
            ...
            <CardContent className="text-sm text-slate-700">
              ...
              <p className="text-xs italic text-slate-500">
                Risk: High. Potential to hit 1Cr earlier (12-13 years).
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <Card className="bg-red-50 border-red-100">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-red-800">
                Pausing during market dips (like 2020) kills your returns. Stay
                invested.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-100">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-red-800">
                ₹1 Cr in 15 years = ~₹41L today. Aim higher (₹1.5 Cr) if
                possible.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-red-50 border-red-100">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-red-800">
                Taking money out for a car or vacation breaks the compounding
                chain.
              </p>
            </CardContent>
          </Card>
      ...
      <Card className="mb-8 border-slate-200 bg-slate-900 text-white">
        <CardContent className="p-8">
          ...
          <p className="mb-6 text-slate-300 leading-relaxed">
            Reaching ₹1 Crore in 15 years is the ideal balance. It requires a
            SIP of ₹19,819 (or ₹11,000 with step-ups). The most important factor
            is to <strong>start immediately</strong>.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2 text-sm bg-slate-800 px-3 py-1 rounded-full border border-slate-700">
              <CheckCircle2 className="h-4 w-4 text-emerald-400" /> Be
              Consistent
            </div>
          </div>
        </CardContent>
