    ...
    <article className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <Card className="mb-10 border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <CardContent className="pt-6 text-slate-700 leading-relaxed text-lg">
          <WikiText
            content={`<p>Earning <strong>₹11 Lakhs (11 LPA)</strong> places you firmly in the mid-senior income bracket. Under the <strong>New Tax Regime (FY 2025-26)</strong>, your income now crosses into the 15% tax slab for the amount exceeding ₹10 Lakhs. However, despite this jump, the New Regime remains highly attractive compared to the Old Regime.</p>`}
          />
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="space-y-4 text-lime-900">
            <p className="text-lg">
              ...
              <span className="font-bold text-xl">₹55,900</span>.
            </p>
            <div className="flex items-start gap-2 bg-white/60 p-3 rounded border border-lime-200 text-sm text-red-800">
              ...
              <span>
                ...
                a tax of <strong>₹1,32,600</strong> unless you can claim
                deductions exceeding <strong>₹4.00 Lakhs</strong>.
              </span>
            </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="border-t-4 border-t-emerald-500 shadow-sm">
            <CardContent className="pt-6">
              ...
              <span className="text-3xl font-bold text-slate-900">₹9.78 L</span>
          ...
          <Card className="border-t-4 border-t-orange-500 shadow-sm">
            <CardContent className="pt-6">
              ...
              <span className="text-3xl font-bold text-slate-900">₹0.56 L</span>
          ...
          <Card className="border-t-4 border-t-blue-500 shadow-sm">
            <CardContent className="pt-6">
              ...
              <span className="text-3xl font-bold text-slate-900">₹0.66 L</span>
        ...
        <Card className="border-slate-200">
          <CardContent className="pt-6">
            <div className="mb-6 bg-slate-50 p-4 rounded border border-slate-200 text-sm text-slate-700">
              ...
              <br />
              Taxable Income: ₹11,00,000 - ₹75,000 = <strong>₹10,25,000</strong>
              .
            </div>
            ...
            <div className="overflow-hidden rounded-lg border border-slate-200 mb-6 shadow-sm">
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell>10L - 10.25L</TableCell>
      ...
      <section className="mb-12">
        ...
        <Card className="border-indigo-100 bg-indigo-50/30">
          ...
          <CardContent className="text-sm text-indigo-800">
            ...
            <p className="text-2xl font-bold text-indigo-700 mb-2">₹4,00,000</p>
            <p>
              This is a high target. It usually requires 80C (₹1.5L) + 80D
              (₹25k) + a substantial Home Loan Interest or HRA claim of at least
              ₹2.25 Lakhs.
            </p>
          </CardContent>
        </Card>
      ...
      <Card className="mb-12 border-slate-200 bg-slate-900 text-white">
        <CardContent className="p-8">
          ...
          <p className="mb-6 text-slate-300 leading-relaxed">
            ...
            efficient and simple. It saves you nearly ₹76,000 compared to the
            Old Regime if you have no deductions. Switch to Old Regime only if
            you have heavy home loan interest or HRA.
          </p>
        </CardContent>
      </Card>
