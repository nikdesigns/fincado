    ...
    <article className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <Card className="mb-10 border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <CardContent className="pt-6 text-slate-700 leading-relaxed text-lg">
          <WikiText
            content={`<p>Earning <strong>₹16 Lakhs (16 LPA)</strong> is a significant milestone. Under the <strong>New Tax Regime (FY 2025-26)</strong>, your taxable income (after standard deduction) falls within the <strong>15% tax slab</strong>. The 20% slab strictly applies only to income exceeding ₹16 Lakhs. This structure makes the New Regime far more efficient than the Old Regime, which levies a flat 30% tax on income above ₹10 Lakhs.</p>`}
          />
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="space-y-4 text-lime-900">
            <p className="text-lg">
              ...
              <strong>New Tax Regime</strong> is the more tax-efficient option.
              Your total tax will be approx{' '}
              <span className="font-bold text-xl">₹1,13,100</span>.
            </p>
            <div className="flex items-start gap-2 bg-white/60 p-3 rounded border border-lime-200 text-sm text-red-800">
              <AlertTriangle className="h-5 w-5 shrink-0 mt-0.5" />
              <span>
                <strong>Old Regime Warning:</strong> The Old Tax Regime results
                in a much higher liability of <strong>₹2,88,600</strong>.
                Choosing the New Regime saves you roughly{' '}
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card className="border-t-4 border-t-orange-500 shadow-sm">
            <CardContent className="pt-6">
              ...
              <span className="text-3xl font-bold text-slate-900">₹1.13 L</span>
            ...
            <div className="overflow-hidden rounded-lg border border-slate-200 mb-6 shadow-sm">
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell>12L - 15.25L</TableCell>
