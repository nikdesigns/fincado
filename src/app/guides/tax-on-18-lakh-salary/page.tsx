        ...
        <CardContent>
          <div className="space-y-4 text-lime-900">
            <p className="text-lg">
              ...
              tax will be approx{' '}
              <span className="font-bold text-xl">₹2,15,800</span>.
            </p>
            <div className="flex items-start gap-2 bg-white/60 p-3 rounded border border-lime-200 text-sm text-red-800">
              ...
              <span>
                ...
                expensive, demanding <strong>₹3,51,000</strong> in tax. Choosing
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card className="border-t-4 border-t-orange-500 shadow-sm">
            <CardContent className="pt-6">
              ...
              <span className="text-3xl font-bold text-slate-900">₹2.16 L</span>
          ...
          <Card className="border-t-4 border-t-blue-500 shadow-sm">
            <CardContent className="pt-6">
              ...
              <span className="text-3xl font-bold text-slate-900">₹1.08 L</span>
            ...
            <div className="overflow-hidden rounded-lg border border-slate-200 mb-6 shadow-sm">
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell>15L - 17.25L</TableCell>
      ...
      <section className="mb-12">
        ...
        <Card className="border-indigo-100 bg-indigo-50/30">
          ...
          <CardContent className="text-sm text-indigo-800">
            ...
            <p>
              This requires significant deductions like maxing out 80C, 80D,
              NPS, and having a Home Loan Interest claim of ₹2 Lakhs plus HRA.
            </p>
          </CardContent>
        </Card>
      </section>
      ...
      <Card className="mb-12 border-slate-200 bg-slate-900 text-white">
        <CardContent className="p-8">
          ...
          <p className="mb-6 text-slate-300 leading-relaxed">
            ...
            most efficient option. It saves you ~₹1.35 Lakhs compared to the Old
            Regime without needing any investment proofs.
          </p>
        </CardContent>
      </Card>
