    ...
    <article className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <Card className="mb-10 border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <CardContent className="pt-6 text-slate-700 leading-relaxed text-lg">
          <WikiText
            content={`<p>Earning <strong>₹30 Lakhs (30 LPA)</strong> places you in the high-income bracket where tax planning becomes critical. Under the <strong>New Tax Regime (FY 2025-26)</strong>, roughly 50% of your income falls into the 30% slab, yet the streamlined structure often results in lower tax outflow compared to the Old Regime.</p>`}
          />
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="space-y-4 text-lime-900">
            <p className="text-lg">
              ...
              <span className="font-bold text-xl">₹5,90,200</span>.
            </p>
            <div className="flex items-start gap-2 bg-white/60 p-3 rounded border border-emerald-200 text-sm text-red-800">
              <AlertTriangle className="h-5 w-5 shrink-0 mt-0.5" />
              <span>
                <strong>Old Regime Warning:</strong> The Old Regime is
                expensive, demanding <strong>₹7,25,400</strong> in tax. Choosing
                the New Regime saves you roughly <strong>₹1.35 Lakhs</strong>.
              </span>
            </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card className="border-t-4 border-t-orange-500 shadow-sm">
            <CardContent className="pt-6">
              ...
              <span className="text-3xl font-bold text-slate-900">₹5.90 L</span>
          ...
          <Card className="border-t-4 border-t-blue-500 shadow-sm">
            <CardContent className="pt-6">
              ...
              <span className="text-3xl font-bold text-slate-900">₹0.24 L</span>
      ...
      <section className="mb-12">
        ...
        <Card className="border-indigo-100 bg-indigo-50/30">
          ...
          <CardContent className="text-sm text-indigo-800">
            ...
            <p className="text-2xl font-bold text-indigo-700 mb-2">₹5,00,000</p>
            <p>
              Since 80C is capped at ₹1.5L, you would need substantial HRA or
              Home Loan Interest claims (approx ₹3.5 Lakhs) to bridge this gap.
            </p>
          </CardContent>
        </Card>
      </section>
