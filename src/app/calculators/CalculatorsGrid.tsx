...
const CalculatorIcon = ({
  ...
  const icons: Record<string, React.ElementType> = {
    ...
    'EMI Prepayment': ArrowDownCircle,
    'SIP Planner': TrendingUp,
    'Mutual Fund Planner': PieChart,
    ...
    'POMIS Calculator': Landmark,
    'KVP Calculator': Gauge,
    ...
    'Capital Gains Calculator': TrendingUp,
    'Brokerage Calculator': Receipt,
    'Rent Receipt Generator': Receipt,
...
const ALL_CALCULATORS: CalculatorItem[] = [
  ...
  },
  {
    ...
    path: '/emi-prepayment-calculator/',
    category: 'Loans',
    desc: 'Estimate interest savings and tenure reduction with part-prepayments.',
    keywords: ['prepayment', 'loan closure', 'interest savings'],
  },
  {
    title: 'SIP Planner',
    path: '/sip-calculator/',
  ...
  {
    title: 'Mutual Fund Planner',
    path: '/mutual-funds/',
    category: 'Investment & Savings',
    desc: 'Build and compare equity, debt, and gold mutual fund portfolio allocations.',
    keywords: ['mutual funds', 'asset allocation', 'portfolio'],
  },
  {
  ...
  },
  {
    ...
    path: '/pomis-calculator/',
    category: 'Investment & Savings',
    desc: 'Estimate monthly income and maturity value from Post Office MIS.',
  },
  {
    title: 'KVP Calculator',
    path: '/kvp-calculator/',
    category: 'Investment & Savings',
    desc: 'Track Kisan Vikas Patra maturity duration and doubling timeline.',
  },
  {
  ...
  },
  {
    ...
    category: 'Retirement & Pension',
    desc: 'Estimate quarterly payout and maturity amount for Senior Citizen Savings Scheme.',
  },
  {
  ...
  },
  {
    ...
    category: 'Tools & Tax',
    desc: 'Estimate in-hand salary after PF, professional tax, and income tax impact.',
  },
  {
    title: 'Capital Gains Calculator',
    path: '/capital-gains-calculator/',
    category: 'Tools & Tax',
    desc: 'Compute STCG/LTCG tax for equity, debt, and property gains.',
  },
  {
    title: 'Brokerage Calculator',
    path: '/brokerage-calculator/',
    category: 'Tools & Tax',
    desc: 'Calculate brokerage, taxes, and net P&L for intraday and delivery trades.',
  },
  {
    title: 'Rent Receipt Generator',
    path: '/rent-receipt-generator/',
    category: 'Tools & Tax',
    desc: 'Generate compliant rent receipts for HRA proof with monthly and yearly summaries.',
  },
  {
