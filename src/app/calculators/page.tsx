...
export default function CalculatorsPage() {
  return (
    <>
      ...
      >
        {/* ✅ FIXED: Use the CSS class for responsive Grid (Stacks on mobile) */}
          ...
          <div style={{ minWidth: 0 }}>
            ...
            <section className="article">
              ...
              <ul>
                ...
                <li>
                  {/* Fixed URL from /retirement-plan to /retirement-calculator */}
                  <a href="/retirement-calculator">Retirement Planner</a> –
                  long-term security
                </li>
              </ul>
