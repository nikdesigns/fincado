      ...
      <table class="w-full text-sm border-collapse">
        ...
        <tbody>
          <tr class="hover:bg-slate-50">
            ...
            <td class="p-3 border text-brand-700">10-12% p.a.</td>
          </tr>
          <tr class="hover:bg-slate-50">
