      ...
      <div className="lg:col-span-5 space-y-6 print:hidden">
        <Alert className="bg-blue-50 border-blue-200 text-blue-800">
          ...
          <AlertDescription className="ml-2 text-xs leading-relaxed">
            ...
            जाने के लिए, जनरेट होने वाली असली रसीद (PDF) अंग्रेजी (English) में
            ही फॉर्मेट की जाएगी।
          </AlertDescription>
        </Alert>
        ...
        <Card className="border-slate-200 shadow-sm">
          ...
          <CardContent className="px-5 pt-5 space-y-5">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="space-y-2">
                <Label htmlFor="tenantName">किरायेदार का नाम (आपका नाम)</Label>
                <Input
                  id="tenantName"
                  value={tenantName}
            ...
            <div className="space-y-2 border-t border-slate-100 pt-4">
              <Label htmlFor="receiptDate">रसीद की तारीख (Receipt Date)</Label>
              <Input
                id="receiptDate"
                type="date"
                value={receiptDate}
