...
export default function HindiSCSSClient() {
        ...
        <Card className="border-[#B0EC70] bg-white shadow-md overflow-hidden h-full flex flex-col">
          ...
          <div className="bg-linear-to-br from-[#F7FDF1] to-white border-b border-[#DFF7C6] p-6 sm:p-8">
            <p className="text-sm font-semibold text-[#577A30] uppercase tracking-wider mb-2 flex items-center gap-2">
              <Wallet className="w-4 h-4" /> त्रैमासिक आय (Quarterly Income)
            </p>
            <h3 className="text-5xl font-semibold text-slate-900 tracking-tighter">
              {formatCurrency(result.quarterlyInterest)}
            </h3>
            <p className="text-sm text-slate-600 mt-2">
              हर 3 महीने में सीधे बैंक खाते में • 100% सुरक्षित
            </p>

            {/* Progress Bar */}
            <div className="mt-8">
              <div className="flex justify-between text-xs font-medium mb-2">
                <span className="text-slate-600">मूलधन (Principal)</span>
                <span className="text-[#74A046]">
          ...
          <CardContent className="p-6 sm:p-8 flex-1 flex flex-col justify-between">
            ...
            <Alert className="mt-8 bg-blue-50 border-blue-100">
              ...
              <AlertDescription className="ml-2 text-xs leading-relaxed">
                <strong>100% सुरक्षित (Government Guaranteed)</strong> • सीनियर
                सिटीजन सेविंग स्कीम भारत सरकार द्वारा पूरी तरह से समर्थित है।
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
